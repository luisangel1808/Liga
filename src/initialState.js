export default {
  players: [
    {
      id: 1,
      name: 'Luis Angel Flórez Salazar',
      description:
    ...
    {
      id: 2,
      name: 'Edwin Adrian Navia Álvarez',
      description:
    ...
    {
      id: 3,
      name: 'Jorge Esteban Tobar Beltrán',
      description:
    ...
    {
      id: 4,
      name: 'Lina Sofia Cardona Martínez',
      description:
  ...
  videos: [
    {
      id: 1,
      title: 'Destroza al blanco con la Caro Kann',
      image: 'https://i.ibb.co/JjvWXyh/Luis.jpg',
      description: 'Aprenderás todos los conceptos de esta defensa',
      url: 'https://www.youtube.com/watch?v=NPEXO4hClNo',
    },
    {
      id: 2,
      title: 'Incinera a tu rival con el dragón',
      image: 'https://i.ibb.co/JjvWXyh/Luis.jpg',
      description: 'Aprenderás todos los conceptos de esta defensa',
      url: 'https://www.youtube.com/watch?v=NPEXO4hClNo',
    },
    {
      id: 3,
      title: 'Revoluciona el juego con la francesa',
      image: 'https://i.ibb.co/JjvWXyh/Luis.jpg',
      description: 'Aprenderás todos los conceptos de esta defensa',
      url: 'https://www.youtube.com/watch?v=NPEXO4hClNo',
    },
    {
      id: 4,
      title: 'Somete a tu rival con el gambito de rey',
      image: 'https://i.ibb.co/JjvWXyh/Luis.jpg',
      description: 'Aprenderás todos los conceptos de esta defensa',
      url: 'https://www.youtube.com/watch?v=NPEXO4hClNo',
    },
    {
      id: 5,
      title: 'Acaba con las blancas con la NimzoIndia',
      image: 'https://i.ibb.co/JjvWXyh/Luis.jpg',
      description: 'Aprenderás todos los conceptos de esta defensa',
      url: 'https://www.youtube.com/watch?v=NPEXO4hClNo',
    },
